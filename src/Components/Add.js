...
export class Add extends Component {
    ...
    input_submit = (e) => {
        ...
        let data = {
            ...
            contact_t: this.state.contact_t,
            ...
            <React.Fragment>
                ...
                <div class="card mt-2 container">
                    <div class="card-header">
                        <h5 class="text-primary">Add Personal Details</h5>
                    </div>
                    <div class="card-body">
                        <form onSubmit={this.input_submit}>
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    Date Of Birth :<input type="date" class="form-control" name="dob" value={this.state.dob} onChange={this.input_change} />
                                </div>
                                <div class="col">
